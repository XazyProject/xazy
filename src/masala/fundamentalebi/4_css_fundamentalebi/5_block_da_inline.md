...
წარმოიდგინეთ აშენებთ სახლს ლეგოს გამოყენებით.

Block: ზოგი ლეგო არის დიდი. ეს ლეგოები იკავებენ მთლიან ხაზს თავისთვის. HTML-ში ასეთი ელემენტებია `<div>`, `<p>`, `<h1>` და ა.შ. ისინი ერთმანეთს თავზე აჯდებიან, რადგან მთლიან ხაზს იკავებენ და გვერძე ვერავინ ეტევა.

Inline: ზოგი ლეგო პატარაა, მაგალითად სახლის ფანჯრები კარებები და ა. შ. მათ შეუძლიათ ერთმანეთის გვერძე იჯდნენ, იმავე ხაზზე. ასეთებია `<a>`, `<span>`, `<img>` და ა.შ. ისინი ერთმანეთის გვერდიგვერდ ზიან.

მაგრამ ამ სტილის გამოყენებით შეგვიძლია დიდი მოუხერხებელი ელემენტები inline-დ ვაქციოთ და პირიქით.
